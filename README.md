...
## Description
CY_Guard est un projet de simulation où un ou plusieurs gardiens patrouillent sur une grille carrée pour attraper des intrus, 
...
## Fonctionnalités
- **Génération de grille** personnalisables (taille, densité d'obstacles, nombre de personnages, etc.).
...
### Fonctionnalités via la barre de menu
